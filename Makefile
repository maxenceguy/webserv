CXX = c++
CXXFLAGS = -Wall -Wextra -Werror -std=c++98 -Iinclude -MMD
...
SRC_FILES = main.cpp	\
			...
			Server/Server.cpp	\
			Server/ServerCgi.cpp \
			Server/ServerUtils.cpp \
			ConfigParser/ConfigParser.cpp \
			ConfigParser/ConfigParserElements.cpp \
			Request/Request.cpp

# Define object files and dependency files from source files
OBJ_FILES = $(SRC_FILES:.cpp=.o)
DEP_FILES = $(SRC_FILES:.cpp=.d)

# Add src and obj directory paths
...
$(NAME): $(OBJ) Makefile
	@echo "$(COLOR_GREEN)Compilation of $(NAME) has started...$(COLOR_RESET)"
